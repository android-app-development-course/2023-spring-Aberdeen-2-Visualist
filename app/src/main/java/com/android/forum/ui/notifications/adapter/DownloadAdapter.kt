...
class DownloadAdapter(val context: Context, val downloads: List<DownloadEntity>) : RecyclerView.Adapter<DownloadAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.name.text = download.content
